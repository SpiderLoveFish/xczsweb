...
<?php } else { ?> 
         <a href="index.php?m=kjlapi&a=initmember"><?php echo L('欢迎你：'),$nickname?> </a>|<a href="#" id="b-tuichu">退出</a>|&nbsp;&nbsp;&nbsp;&nbsp;<img src="Public/Home/images/tel.png"/>   
               <?php  }  ; ?> 
                </span> </div>
  </div>
...
<div id="miniBus" style="right:-280px;">
  <div class="mini-bar">
    ...
    <a class="wx1"><img src="i<?php echo IMG_PATH;?>xczs/mages/wx_1.png"></a>
