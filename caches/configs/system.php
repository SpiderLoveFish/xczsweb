...
'cookie_pre' => 'DpgzB_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://localhost/xczs/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://localhost/xczs/statics/js/', //CDN JS
'css_path' => 'http://localhost/xczs/statics/css/', //CDN CSS
'img_path' => 'http://localhost/xczs/statics/images/', //CDN img
'app_path' => 'http://localhost/xczs/',//动态域名配置地址

///增加的地址2016-0627
'kjlaip_path' => 'http://mb.xczs.co/webserver/kjlapi.asmx/',//动态域名配置地址
'kjl_public_ac'=>'admin',//登录酷家乐的公共账号
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'xIxwPz1g2gcgZ5uSgWMu', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://www.xczs.com/phpsso_server',	//接口地址
'phpsso_auth_key' => 'QnGnaeYmE0mUgV2WIGEI8TFPKlD6GPyk', //加密密钥
